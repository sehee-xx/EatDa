...
public class GlobalException extends RuntimeException {
     ...
     * 상세 정보 포함 생성자
     */
    public GlobalException(final ErrorCode errorCode, final Object details) {
     ...
     */
    public GlobalException(final ErrorCode errorCode, final Object details, final Throwable cause) {
