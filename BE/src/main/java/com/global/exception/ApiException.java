...
/**
 * 전역 비즈니스 예외 처리 클래스. 서비스 로직 내에서 throw 시 프론트에 일관된 에러 응답을 전달한다.
 */
@Getter
public class ApiException extends RuntimeException {
     ...
     * 상세 정보 포함 생성자
     */
    public ApiException(final ErrorCode errorCode, final Object details) {
     ...
     */
    public ApiException(final ErrorCode errorCode, final Object details, final Throwable cause) {
